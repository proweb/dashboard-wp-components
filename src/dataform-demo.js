...
/**
 * The DataForm demo screen.
 *
 * It lives in its own module so `@wordpress/dataviews/wp` (and its heavy
 * dependency tree) is pulled into a separate, lazily-loaded Webpack chunk
 * instead of the main `index.js` shell. The chunk is only fetched once this
 * screen is rendered on the demo page.
 *
 * @since n.e.x.t
 */
const DataFormDemo = () => {
